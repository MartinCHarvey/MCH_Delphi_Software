...
{**********************************************************************}
{}
{ $Log:  10103: mwStringHashList.pas 
{
...
type
  TmwStringHash = function(const aString: AnsiString): Integer;
  TmwStringHashCompare = function(const Str1: AnsiString; const Str2: AnsiString): Boolean;

  TmwHashWord = class
    S: AnsiString;
    Id: Integer;
    ExID: Integer;
    constructor Create(aString: AnsiString; anId, anExId: Integer);
  end;
  ...
  public
    procedure AddString(aString: AnsiString; anId, anExId: Integer);
  end;
  ...
  public
    ...
    procedure AddString(aString: AnsiString; anId, anExId: Integer);
    function Hash(const S: AnsiString; var anId: Integer; var anExId: Integer): Boolean;
    function HashEX(const S: AnsiString; var anId: Integer; var anExId: Integer; HashValue: Integer): Boolean;
  end;

function CrcHash(const aString: AnsiString): integer;
function ICrcHash(const aString: AnsiString): integer;
function SmallCrcHash(const aString: AnsiString): integer;
function ISmallCrcHash(const aString: AnsiString): integer;
function TinyHash(const aString: AnsiString): Integer;
function ITinyHash(const aString: AnsiString): Integer;
function HashCompare(const Str1: AnsiString; const Str2: AnsiString): Boolean;
function IHashCompare(const Str1: AnsiString; const Str2: AnsiString): Boolean;

function HashSecondaryOne(const aString: AnsiString): Integer;
function HashSecondaryTwo(const aString: AnsiString): Integer;
...
begin
  ...
  for I := #0 to #255 do
    mwInsensitiveHashTable[I] := mwHashTable[AnsiLowerCase(AnsiString(I))[1]];
end;
...
constructor TmwHashWord.Create(aString: AnsiString; anId, anExId: Integer);
begin
  inherited Create;
  S := aString;
  Id := anId;
...
procedure TmwHashStrings.AddString(aString: AnsiString; anId, anExId: Integer);
begin
...
procedure TmwHashItems.AddString(aString: AnsiString; anId, anExId: Integer);
var
...
procedure TmwStringHashList.AddString(aString: AnsiString; anId, anExId: Integer);
var
  HashWord: TmwHashWord;
  HashValue: Integer;
...
function TmwStringHashList.Hash(const S: AnsiString; var anId: Integer; var anExId: Integer): Boolean;
begin
  Result := HashEX(S, anId, anExId, fHash(S));
end;

function TmwStringHashList.HashEX(const S: AnsiString; var anId: Integer; var anExId: Integer; HashValue: Integer): Boolean;
var
  Temp: TObject;
  Hashword: TmwHashWord;
  HashItems: TmwHashItems;
